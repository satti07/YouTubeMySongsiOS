...
static NSString* noSongFoundHTML = @"<!DOCTYPE html><html><head><style>body {background-repeat:no-repeat;background:-webkit-linear-gradient(top, rgba(1,1,1,1) 0%,rgba(1,1,1,0) 100%) fixed;height: 100%;width: 100%;} .format{text-align:center;font-family:\"Helvetica Neue\";font-weight:lighter;;color:white} #heading{font-size:14pt;font-style:italic;padding:4px} #text{font-size:10pt;font-style:bold;padding:2px}</style></head> <body> <p class=\"format\" id=\"heading\">YouTube MySongs</p><p class=\"format\" id=\"text\">Sorry, could not find any video :(</p></body> </html>";
static NSString* welcomeHTML = @"<!DOCTYPE html><html><head><style>body {background-repeat:no-repeat;background:-webkit-linear-gradient(top, rgba(1,1,1,1) 0%,rgba(1,1,1,0) 100%) fixed;height: 100%;width: 100%;} .format{text-align:center;font-family:\"Helvetica Neue\";font-weight:lighter;;color:white} #heading{font-size:14pt;font-style:italic;padding:4px} #text{font-size:10pt;font-style:bold;padding:2px}</style></head> <body> <p class=\"format\" id=\"heading\">YouTube MySongs</p><p class=\"format\" id=\"text\">Select a song to watch its video</p><p class=\"format\" id=\"text\">Enjoy! :)</p></body> </html>";
